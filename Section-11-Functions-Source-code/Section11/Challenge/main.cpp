...
void largest_one(vector<int>);
void smallest_one(vector<int>);
...
void smallest_one(vector<int> numbers) {
	if (numbers.size() == 0) 
...
void largest_one(vector<int> numbers) {
	if (numbers.size() == 0) 
		cout << "Unable to determine the smallest - list is empty" << endl;
	else {
